...
parser.add_argument("--n1", type=int, default = 242, help = "number of neurons in the first layer of the neural network")
parser.add_argument("--n2", type=int, default = 111, help = "number of neurons in the second layer of the neural network")
parser.add_argument("--n3", type=int, default = 213, help = "number of neurons in the third layer of the neural network")
